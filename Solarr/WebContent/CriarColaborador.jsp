...
<body>
    ...
    <div id="main" class="container">
        <h3 class="page-header">Incluir Colabordor</h3>
        ...
        <form action="controller.do" method="post">
            ...
            <div id="actions" class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary" name="command" value="CriarColab">Salvar</button>
