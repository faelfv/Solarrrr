          					...
          					<c:forEach var="colaborador" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <button id="btn${colaborador.idcolab }%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-colaborador="${colaborador.idcolab }">Excluir</button>
                                            </td>
                                        </tr>             
                            </c:forEach>
